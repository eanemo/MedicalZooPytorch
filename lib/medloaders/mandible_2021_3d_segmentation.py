...
class Mandible_Seg_Dataset(Dataset):
    """
    ...
    def __init__(self, mode, sub_task='lung', split=0.2, fold=0, n_classes=2, samples=10, dataset_path='../datasets',
                 crop_dim=(32, 32, 32)):
        print("MANDIBLE SEGMENTATION DATASET")
        self.CLASSES = n_classes
        self.fold = int(fold)
        self.crop_size = crop_dim
        self.full_vol_dim = (512, 512, 192)  # width, height,slice,
        self.mode = mode
